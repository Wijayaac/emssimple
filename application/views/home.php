                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img class="rounded-circle" src="<?= base_url() ?>assets/images/users/avatar-2.jpg" alt="user" width="40"> </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded-circle" src="<?= base_url() ?>assets/images/users/avatar-4.jpg" alt="user" width="40"> </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded-circle" src="<?= base_url() ?>assets/images/users/avatar-5.jpg" alt="user" width="40"> </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded-circle" src="<?= base_url() ?>assets/images/users/avatar-6.jpg" alt="user" width="40"> </td>
                                        <td>
                                            <a href="javascript:void(0);">Ruby T. Curd</a>
                                        </td>
                                        <td>
